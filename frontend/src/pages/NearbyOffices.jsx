...
const NearbyOffices = () => {
  ...
  const offices = [{
    ...
    id: 2,
    name: 'Municipal Corporation Head Office',
  ...
  return <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <p className="text-slate-500">{t("NearbyOffices.find_official_centers_get")}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredOffices.map((office, idx) => <motion.div initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
