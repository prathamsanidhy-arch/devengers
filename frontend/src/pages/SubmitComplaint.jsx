...
const SubmitComplaint = () => {
  ...
  const handleAnalyzeAI = async () => {
    ...
    try {
      ...
      const response = await api.post('/ai/analyze', { imageBase64: base64Image, mimeType });
      const { title, description, category, priority, department, confidenceScore } = response.data.data;
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-slate-900">Photo Evidence</h2>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
                ...
                {imagePreview ? (
                  <>
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                      ...
                      <span className="font-medium text-slate-900 bg-white/80 px-3 py-1 rounded-full backdrop-blur-sm">Change Photo</span>
                    </div>
                  </>
                ) : (
            ...
            <div className="sm:w-64 flex flex-col justify-center">
              <div className="bg-purple-50 rounded-2xl p-5 border border-purple-100">
                ...
                <h3 className="font-semibold text-purple-900 mb-1">Smart Analysis</h3>
                <p className="text-sm text-purple-700/80 mb-4">Our AI will automatically detect the issue, category, and department.</p>
                <button
                  type="button"
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              {aiData.confidenceScore && (
                <div className={`px-3 py-1 rounded-full text-sm font-semibold flex items-center gap-1.5 ${aiData.confidenceScore > 75 ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'}`}>
                  {aiData.confidenceScore > 75 ? <CheckCircle2 className="w-4 h-4" /> : <AlertCircle className="w-4 h-4" />}
                  AI Confidence: {aiData.confidenceScore}%
                </div>
              )}
            </div>
            ...
            {aiData.department && (
               <div className="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Routed Department</p>
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">AI Severity</p>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex justify-end gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-brand-600 text-white px-8 py-2.5 rounded-xl font-medium shadow-lg shadow-brand-500/30 hover:bg-brand-500 hover:-translate-y-0.5 transition-all disabled:opacity-50 flex items-center gap-2"
              >
